...
const SearchNew = ({id,name,title,company,location,type,company_url,created_at,company_logo}) => {
   const style ={
     fontWeight:"bold"
   }
   const Trevon ={
   ...
   const {NewArray}= useGlobalContext()
    ...
    return (
        ...
        <div className="col s12 m4" key={id} >
              <div className="card-panel" onClick={()=>NewArray(id)}>
                   <p  style={style}>New</p>
